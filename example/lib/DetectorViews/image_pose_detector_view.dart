...
class ImagePoseDetectorView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ImagePoseDetectorViewState();
}

class _ImagePoseDetectorViewState extends State<ImagePoseDetectorView> {
